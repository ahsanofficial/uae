...
//     const [testimonialsPerPage, setTestimonialsPerPage] = useState(window.innerWidth > 600 ? 5 : 1);

//     useEffect(() => {
//         const handleResize = () => {
//             if (window.innerWidth > 600) {
//                 setTestimonialsPerPage(5);
//             } else {
...
//     return (
//         <div className={`flex justify-evenly pt-10 ${styles.bg}`}>
